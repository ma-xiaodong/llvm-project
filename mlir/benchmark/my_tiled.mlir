...
#map1 = affine_map<(d0) -> (d0 + 160, 2088)>
...
module  {
  ...
  func @matmul(%arg0: memref<2088x2048xf32>, %arg1: memref<2048x2048xf32>, %arg2: memref<2088x2048xf32>) {
    affine.for %arg3 = 0 to 2048 step 256 {
      affine.for %arg4 = 0 to 2088 step 160 {
        affine.for %arg5 = 0 to 2048 step 16 {
          affine.for %arg6 = #map0(%arg4) to min #map1(%arg4) step 4 {
            affine.for %arg7 = #map0(%arg3) to #map2(%arg3) {
              affine.for %arg8 = 0 to 16 {
                affine.for %arg9 = #map0(%arg6) to #map4(%arg6) {
                  %0 = affine.load %arg0[%arg9, %arg7] : memref<2088x2048xf32>
                  %1 = affine.load %arg1[%arg7, %arg5 + %arg8] : memref<2048x2048xf32>
                  %2 = affine.load %arg2[%arg9, %arg5 + %arg8] : memref<2088x2048xf32>
                  %3 = mulf %0, %1 : f32
                  %4 = addf %3, %2 : f32
                  affine.store %4, %arg2[%arg9, %arg5 + %arg8] : memref<2088x2048xf32>
                }
              }
            }
          }
